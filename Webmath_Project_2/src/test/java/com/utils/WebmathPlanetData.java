...
public class WebmathPlanetData {
	WebDriver driver ;
  ...
  public void beforeMethod() {
	  ...
	  try {
		  ...
		  FileInputStream input = new FileInputStream("D:\\Anudip Foundation\\Programs\\Webmath_Project_2\\src\\test\\java\\Properties\\WebmathPlanetData.properties");
		  prop.load(input);
