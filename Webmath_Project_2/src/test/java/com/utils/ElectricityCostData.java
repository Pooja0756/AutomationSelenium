...
public class ElectricityCostData {
	WebDriver driver ;
  ...
  public void beforeMethod() throws IOException {
	  ...
	  FileInputStream input = new FileInputStream("D:\\Anudip Foundation\\Programs\\Webmath_Project_2\\src\\test\\java\\Properties\\WebmathElectricityCostData.properties");
	  prop.load(input);
